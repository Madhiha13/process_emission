...
app.post('/processemission_dataentry', (req, res) => {
...
app.get('/processemission_dataentry', (req, res) => {
  const dataEntries = readDataEntries();
...
console.log("your endpoint will be: http://localhost:5000/processemission_dataentry");