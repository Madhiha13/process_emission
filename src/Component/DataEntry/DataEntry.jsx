...
import { whitevariationSvg, FolderSvg, CircleSvg, Img, GreenSvg, Co2, PiechartSvg, AddIcon, SearchSvg, UploadSvg, User, Leftarrow, Layer1, Layer2, Layer3 } from "./../../assets";
...
const DataEntry = () => {
  ...
  const rowCount = rows.length;
      ...
      try {
          ...
          if (rowData.file) {
              ...
              if (response.status === 200) {
                  ...
                  await axios.post('http://localhost:5000/processemission_dataentry', data);
        ...
        return rows.map((rowData, index) => (
            <div className='row-bar' key={index}>
                <div className="data-row">
                    <input type="text" placeholder="Type of gas emitted" className="mobile-combustion-data-entry-child1-vehicle" value={rowData.GasType} onChange={(e) => handleInputChange(index, 'GasType', e.target.value)} />
                    ...
                    <input className="mobile-combustion-data-entry-child3-quantity" type="text" placeholder="Quantity of Gas Emitted" value={rowData.quantity} onChange={(e) => handleInputChange(index, 'quantity', e.target.value)} />
    ...
    return (
      ...
      <div className="type-of-vehicle2">Type of Gas</div>
